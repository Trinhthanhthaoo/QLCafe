    ...
    public void FillBan(){
        ...
        if(arrBan != null){
            ...
            for(int i=0;i<arrBan.size();i++){
                ...
                if(arrBan.get(i).GetTrangThai().equals("serving")){
                    btn[i].setBackground(Color.decode("#66ff66"));
                }
                if(arrBan.get(i).GetTrangThai().equals("reserved")){
                ...
                btn[i].addMouseListener(new MouseAdapter() {
                        ...
                        public void mousePressed(MouseEvent e) {
                            JpGoiMon goimon;
                // hiểm thị thông tin bàn (số bàn ...)
                            ban = cn.GetBan(Integer.parseInt(e.getComponent().getName()));
                //nếu được chọn ( không null ) hiện lên cái gọi món
                            if(ban != null){                            
