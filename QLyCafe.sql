CREATE TABLE ban (
  MaBan INT NOT NULL,
  TenBan VARCHAR(55) COLLATE Vietnamese_CI_AS NOT NULL,
  TrangThai VARCHAR(50) COLLATE Vietnamese_CI_AS NOT NULL
);
-- Thay đổi kiểu dữ liệu và collation của cột TenBan và TrangThai
ALTER TABLE ban
ALTER COLUMN TenBan NVARCHAR(55) COLLATE Vietnamese_CI_AS NOT NULL;

ALTER TABLE ban
ALTER COLUMN TrangThai NVARCHAR(50) COLLATE Vietnamese_CI_AS NOT NULL;
ALTER TABLE ban
ALTER COLUMN TenBan VARCHAR(55) COLLATE Latin1_General_100_CI_AS_SC_UTF8 NOT NULL;

ALTER TABLE ban
ALTER COLUMN TrangThai VARCHAR(50) COLLATE Latin1_General_100_CI_AS_SC_UTF8 NOT NULL;
--
...
CREATE TABLE `nhommon` (
  `MaLoai` int(11) NOT NULL,`TenLoai` varchar(55) COLLATE utf8_unicode_ci NOT NULL,
...
--
ALTER TABLE `thucdon`
  ADD CONSTRAINT `thucdon_ibfk_1` FOREIGN KEY (`MaLoai`) REFERENCES `nhommon` (`MaLoai`);tdacsaikhoanqlclbaccphieuxuat